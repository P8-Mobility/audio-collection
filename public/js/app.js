...
function createDownloadLink(blob) {
	...
	upload.addEventListener("click", function(event){
		...
		let messageTimeout = setInterval(function(){
	...
	discard.href="#";
	discard.innerHTML = "Slet";
    discard.classList.add("btn");
    discard.classList.add("btn-danger");
    discard.style.color = "white";
	...
	li.appendChild(document.createTextNode (" "))//add a space in between
	li.appendChild(discard)//add the upload link to li
